  ...
  describe "run expressions" do
    ...
    describe "xth day of a month" do
      it "can give me the last friday day of a month" do
          ...
          last_friday_of_a_month.should include Date.parse("30-07-2010")
      end
    ...
    describe "first day of a year" do
      it "can give me the first day in a year" do
        ...
        first_day.should include Date.parse("01-01-2010")
        first_day.should include Date.parse("01-01-2009")
      end
    ...
    describe "first specified weekday of a year" do
      ...
      it "can be represented as string" do
        first_sunday_in_january.to_s.should == 'every January 0th through January 0th and 1st Sunday of the month'
      end
    end
  end
end
